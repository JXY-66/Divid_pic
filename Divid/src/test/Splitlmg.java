...
public class Splitlmg {

    private static String redUrl = "/home/yingbao/jxy/Divid/images/f1.jpg";//需要分割图片所在路径
    private static String saveUrl = "/home/yingbao/jxy/Divid/img";//分割后保存路径
